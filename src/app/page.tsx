...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center p-24 bg-bdki-darkest">
      {/* INTRO SECTION */}
      <section className='w-full flex justify-center items-center mb-12 bg-bdki-light-grey'>
        <div className='p-4'>
      ...
      {/* ABOUT SECTION */}
      <section className='w-full bg-bdki-light-grey flex justify-center items-center mb-12'>
        <div className='p-4'>
